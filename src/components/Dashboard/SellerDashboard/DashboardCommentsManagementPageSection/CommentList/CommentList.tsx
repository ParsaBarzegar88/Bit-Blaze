...
const CommentList: FC<IProps> = ({ searchParams = {} }) => {
    ...
    return (
        <div className="w-full overflow-x-auto custom-scrollbar">
            <div className="w-full flex flex-col gap-3 sm:gap-2 min-w-[900px]">
                <div className="bg-[#F0F0F0] dark:bg-[#4a4a4a] dark:shadow-[0_0px_5px_rgba(0,0,0,0.3)] shadow-[0_0px_5px_rgba(0,0,0,0.27)] w-full items-center grid grid-cols-4 gap-2 py-3 px-2 sm:py-2 sm:px-3 rounded-[10px]">
                ...
                <div className="flex flex-col gap-1">
                    <div
                        // key={item.id}
                        className="grid grid-cols-4 gap-2 sm:gap-7 items-center py-6 px-2 sm:py-6 sm:px-2 rounded-[10px] hover:bg-gray-200 dark:hover:bg-[#444444] transition-colors duration-300"
                    >
                        ...
                        <div className="col-span-1 text-center flex justify-center items-center">
                            <span className="text-xs sm:text-sm font-[600] text-[#272727] dark:text-gray-300">
                                {/* {formatToPersianDate(item.reservedDates[0].value)} */}ddd
                            </span>
                        </div>
                        <div className="flex relative col-span-1 text-center text-gray-700 dark:text-gray-300 font-medium items-center justify-center">
                            <div className="p-1.5 rounded-lg hover:bg-gray-200 dark:hover:bg-[#555555] cursor-pointer transition-colors duration-200">
                                ...
                                <IoIosMore size={25} className="text-gray-600 dark:text-gray-400"/>
                            </div>
