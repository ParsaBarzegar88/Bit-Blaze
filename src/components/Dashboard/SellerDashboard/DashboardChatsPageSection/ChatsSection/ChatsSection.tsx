...
const ChatsSection: FC<IProps> = ({ roomId , setRoomId , setOpenChat , openChat}) => {
    ...
    return (
        Number(roomId) > 0 ? (
            <div className={`flex flex-col w-full ${openChat === true ? "max-[750px]:w-full" : "max-[750px]:w-0"}`}>
                <div className='flex flex-row w-full justify-between border-b items-center px-3'>
                    <div className='flex max-[400px]:text-[12px] flex-row gap-2.5 w-full tex-black items-center  pb-3 py-2'>
                ...
                <div className='max-h-[660px] h-full overflow-y-auto px-1'>
                ...
                <div className='flex flex-row w-full gap-1.5 mt-2 mb-2 justify-center border-t border-gray-300 pt-2 px-2'>
                    <input
                        ...
                        className='w-full outline-none border-none dark:text-white text-black dark:bg-gray-700 bg-gray-400 px-3 py-2 rounded-lg'
                    />
                    <IoIosSend
            ...
            <div className={`flex flex-col justify-center mx-auto items-center ${openChat === true ? "max-[750px]:w-full " : "max-[750px]:w-0 max-[750px]:hidden"}`}>
