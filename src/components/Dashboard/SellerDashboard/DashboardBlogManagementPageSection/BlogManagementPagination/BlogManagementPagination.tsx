...
const BlogManagementPagination: FC<IProps> = ({ userSellerBlogInfo }) => {
    ...
    const totalPages = Math.ceil(userSellerBlogInfo.totalCount / ITEMS_PER_PAGE);
...
export default BlogManagementPagination