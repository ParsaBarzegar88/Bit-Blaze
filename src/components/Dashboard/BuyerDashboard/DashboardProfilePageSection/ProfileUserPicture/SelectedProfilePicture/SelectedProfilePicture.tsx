...
const SelectedProfilePicture: FC<IProps> = ({ closeSelectedPicture }) => {
  ...
  return (
    <div
      className="fixed left-[50%] top-[50%] z-50 w-full max-w-lg translate-x-[-50%] translate-y-[-50%] border bg-background p-6 shadow-lg duration-200 
    ...
    >
      <div className="flex flex-row justify-between w-full items-center">
        ...
        <div className="flex flex-row gap-1.5 cursor-pointer items-center border border-[#FF4242] text-[#FF4242] py-1 px-2 rounded-[20px]">
          ...
          <span
            ...
            onClick={() => closeSelectedPicture(false)}
          >
            بستن
          </span>
        </div>
      ...
      <div className="flex flex-row gap-2">
        <button
          className="px-3 py-2 rounded-[12px] bg-[#d8d8d8] cursor-pointer text-[#888888]"
