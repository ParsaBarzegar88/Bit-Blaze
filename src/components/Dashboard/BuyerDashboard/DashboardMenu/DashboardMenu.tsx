            ...
            <div className='flex flex-col h-full justify-between max-w-[90%] w-full mx-auto'>
                <div className='flex flex-col gap-10 w-full'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <Link href={'/dashboard-payments'} className={`flex items-center ${pathName === '/dashboard-payments' ? 'bg-[#E0E0E0] dark:bg-[#a08cff]' : ""} ${open === true ? 'w-full ' : "w-fit pl-2"} pr-2 px-3 py-2 flex-row gap-1.5 dark:text-white  text-black transition-colors hover:bg-[#E0E0E0] dark:hover:bg-[#a08cff] rounded-[8px] cursor-pointer`}>
                        ...
                        <Link href={'/dashboard-announcements'} className={`flex items-center ${pathName === '/dashboard-announcements' ? 'bg-[#E0E0E0] dark:bg-[#a08cff]' : ""} ${open === true ? 'w-full ' : "w-fit pl-2"} pr-2 px-3 py-2 flex-row gap-1.5 dark:text-white  text-black transition-colors hover:bg-[#E0E0E0] dark:hover:bg-[#a08cff] rounded-[8px] cursor-pointer`}>
