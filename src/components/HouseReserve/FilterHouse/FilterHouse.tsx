        ...
        <div className="flex flex-col max-md:flex-col md:flex-row gap-3 sm:gap-4 lg:gap-5 w-full items-start">
          <div className="w-full md:w-[200px] lg:w-[220px]">
            <Popover open={openProvince} onOpenChange={setOpenProvince}>
              <PopoverTrigger asChild>
                <div className='group'>
                  <p className='dark:group-hover:text-[#FFFFFF] group-hover:text-[#363636] dark:text-[#AAAAAA] text-[#000000] font-[400] text-xs sm:text-[13px] mb-1'>مقصد یا هتل شما :</p>
                  <Button
                    variant="outline"
                    role="combobox"
                    aria-expanded={openProvince}
                    className="w-full h-[44px] sm:h-[50px] justify-between dark:bg-[#303030]  dark:border-[#AAAAAA] rounded-xl sm:rounded-2xl border-[#AAAAAA] dark:group-hover:border-[#FFFFFF] dark:group-hover:text-[#FFFFFF] dark:text-[#AAAAAA] dark:hover:bg-[#353535] text-sm sm:text-base"
                  >
              ...
              <PopoverContent className="p-0 border-none w-fit" align="start">
                <Command className="bg-white dark:bg-[#303030] border-none rounded-[3px]">
                  ...
                  <CommandList className="max-h-[200px]">
                    <CommandEmpty className="dark:text-white text-black">استان یافت نشد</CommandEmpty>
                    <CommandGroup>
                      {provinces.map((province) => (
                        <CommandItem
                          ...
                          className="dark:text-white text-black rounded-[3px]"
                        >
          ...
          <div className="w-full md:w-[200px] lg:w-[220px]">
            <Popover open={openSort} onOpenChange={setOpenSort}>
              <PopoverTrigger asChild>
                <div className='group'>
                  <p className='dark:group-hover:text-[#FFFFFF] group-hover:text-[#363636] dark:text-[#AAAAAA] text-black font-[400] text-xs sm:text-[13px] mb-1'>مرتب سازی بر اساس :</p>
                  <Button
                    variant="outline"
                    role="combobox"
                    aria-expanded={openSort}
                    className="w-full h-[44px] sm:h-[50px] justify-between dark:bg-[#303030] dark:text-[#AAAAAA] text-black dark:border-[#AAAAAA] border-[#AAAAAA] rounded-xl sm:rounded-2xl dark:group-hover:border-[#FFFFFF] dark:group-hover:text-[#FFFFFF] dark:hover:bg-[#353535] text-sm sm:text-base"
                  >
                    <div className='flex flex-row gap-2 items-center'>
          ...
          <div className="w-full md:w-fit lg:w-[300px] xl:w-[400px] relative">
            <div onClick={handleShowSaveSearch} className="group">
              ...
              <input
                type="text"
                className="w-full h-[44px] sm:h-[50px] px-3 dark:bg-[#353535] border-[#AAAAAA] placeholder:text-black text-black bg-white border dark:border-[#AAAAAA] rounded-xl sm:rounded-2xl dark:group-hover:border-[#FFFFFF] dark:text-[#AAAAAA] dark:group-hover:text-[#FFFFFF] dark:placeholder:text-[#AAAAAA] dark:hover:bg-[#353535] dark:focus:outline-none dark:focus:border-[#FFFFFF] dark:focus:text-[#FFFFFF] text-right text-sm sm:text-base"
