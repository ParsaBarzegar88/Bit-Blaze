                    ...
                    {AiResult !== null && !AiResult.message ? (
                        ...
                        <p className='text-center'>
                            ...
                            <div className=" text-emerald-600 dark:text-emerald-400 flex flex-row justify-between w-full">
                                ...
                                <Link className='bg-emerald-600 dark:bg-emerald-500 text-white dark:text-[#333333] rounded-[8px] p-1.5' href={`/house-reserve/${AiResult.id}`}>مشاهده جزئیات بیشتر</Link>
                            </div>
