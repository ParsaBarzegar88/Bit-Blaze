        ...
        <>
            <div className='max-w-[100%] w-full flex flex-col sm:flex-row m-3 justify-between'>
                ...
                <div className='flex flex-row gap-3 mt-4 md:mt-0 items-center'>
                    ...
                    <div onClick={() => HandleShowWishList(Info?.id?.toString())} className='w-11 h-9 rounded-[12px] flex items-center hover:scale-110 cursor-pointer duration-300 justify-center px-3 dark:bg-[#393939] bg-[#dadadae9]'>
                        <RiPushpinLine size={18} className='dark:text-white text-black' />
                    </div>
