  ...
  return (
    <>
      ...
      <div className="max-w-[98%] w-full mx-auto px-2 sm:px-4">
        ...
        <div
          className={`${Style.beforeMargin} max-[400px]:rounded-tr-[17px] max-[400px]:before:hidden max-[400px]:after:hidden bg-[#58893a] dark:bg-[#8CFF45] mb-5 relative w-full pb-2 sm:mt-0 mt-10 rounded-tl-[24px] rounded-bl-[24px] rounded-br-[24px]
        ...
        >
          <div
            className="absolute max-[400px]:hidden top-[-3.9rem] right-[5px] w-[280px] h-[2.1rem] rounded-[34px] 
                        outline-[5px] outline-[#58893a] dark:outline-[#8CFF45] transition-all duration-300"
          ></div>
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-8 mt-8">
              <div className="flex flex-col gap-3 w-full lg:w-1/2">
                ...
                <h2 className="dark:text-[#363636] text-white font-[500]">
                  <b className="text-2xl md:text-[30px] text-white dark:text-[#363636]">
                    24 ساعت روز و 7 روز هفته در اختیار شماییم !
                  </b>
                </h2>
                <p className="dark:text-[#363636] text-white text-sm md:text-base">
                ...
                >
                  ...
                  <button
                    type="submit"
                    disabled={pending}
                    className="flex flex-row gap-3 justify-center items-center bg-white dark:bg-[#363636] text-black dark:text-[#FFFFFF] w-full h-[50px] rounded-2xl"
                  >
                    {pending ? (
              ...
              <div className="relative w-full lg:w-1/2 justify-center lg:justify-end mt-8 lg:mt-0 hidden lg:flex">
                <div className="relative w-full max-w-[350px] lg:max-w-[450px]">
                  ...
                  <FaStar
                    size={12}
                    className="absolute text-[#232323] top-[15%] right-2"
                  />
                  <FaStar
                    size={10}
                    className="absolute text-[#232323] top-[-5%] right-[45%]"
                  />
                  <FaStar
                    size={16}
                    className="absolute text-[#232323] top-[45%] right-2"
                  />
                  <FaStar
                    size={16}
                    className="absolute text-[#232323] top-[45%] left-2"
                  />
                  <FaStar
                    size={12}
                    className="absolute text-[#232323] top-[15%] left-2"
                  />
                  <FaStar
                    size={16}
                    className="absolute text-[#232323] top-[2%] left-[15%]"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-6 bg-[#232323] lg:mt-0 h-fit max-w-[98%] mt-2 mx-auto my-5 w-full rounded-[24px] sm:rounded-[46px] p-4 sm:p-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 sm:items-center lg:items-start lg:grid-cols-4 gap-8 max-w-[97%] mx-auto w-full">
              ...
              <div className="flex flex-col gap-3">
                <span className="text-lg md:text-[18px] text-[#FFFFFF]">
                  نحوه رزرو اقامتگاه
                </span>
                <span className="text-sm md:text-[14px] text-[#FFFFFF]">
                  راهنمای رزرو اقامتگاه
                </span>
                <span className="text-sm md:text-[14px] text-[#AAAAAA]">
                  شیوه پرداخت
                </span>
                <span className="text-sm md:text-[14px] text-[#AAAAAA]">
                  لغو رزرو اقامتگاه
            ...
            <div className="flex flex-row gap-5 max-w-[97%] mx-auto w-full my-5 justify-center sm:justify-start">
              <div className="bg-white rounded-2xl flex justify-center items-center w-12 h-12 sm:w-14 sm:h-14">
                <Image
                  src={NationalBusinessAssociation}
                  alt="NationalBusinessAssociation"
                  width={50}
                  height={50}
