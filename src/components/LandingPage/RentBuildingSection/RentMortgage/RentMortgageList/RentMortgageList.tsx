...
const RentMortgageList: FC<IProps> = ({ housesData, type }) => {
    const discountPercentage = calculateDiscountPercentage(housesData.price, housesData.discounted_price);
    return (
        <div className='w-full max-w-full mt-5 group mx-auto'>
            <div className='flex flex-col relative'>
                ...
                <div className='flex flex-row justify-between items-center'>
                    <h3 className='dark:text-[#FFFFFF] text-black font-[500] text-[14px] sm:text-[16px] mt-5 mr-1'>
                        {housesData.title}
                    </h3>
                    {housesData.discounted_price !== null ?
                        (
                ...
                <div className='bg-[#444444] group-hover:bg-[#58893a] dark:group-hover:bg-[#8CFF45] transition-all duration-300 group-hover:text-[#363636] text-[#AAAAAA] text-[14px] sm:text-[16px] mt-3 w-full p-2 rounded-[12px]'>
                    <div className='flex flex-row justify-between p-1'>
                        <p>{type === 'rental' ? "اجاره ماهیانه :" : "رهن :"}</p>
                        <div className='flex flex-row text-[#FFFFFF] group-hover:text-[#363636] transition-all duration-300'>
                            <div className='text-[#FFFFFF] group-hover:text-[#363636] transition-all duration-300'>
                                {housesData.discounted_price ? housesData.discounted_price : housesData.price}ت
                            </div>
                            <div className='text-[#AAAAAA] group-hover:text-[#363636] transition-all duration-300 mr-1'>
                                /هر ماه
                            </div>
                        </div>
                    </div>
...
export default RentMortgageList