    ...
    return (
        <div className={` ${Style.auto} max-w-[512px] h-[100px] w-full flex flex-col gap-4 mt-10`}>
            <div className='max-w-[160px] w-full flex flex-row gap-3 items-center justify-center'>
                <span className='dark:text-[#AAAAAA] text-black max-w-[23px] w-full text-[13px] font-[400]'>خانه</span>
                <svg width="7" height="10" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.00008 9L2 5.00008L6.00008 1" stroke="#AAAAAA" strokeWidth="2" />
                </svg>
                <span className='dark:text-[#8CFF45] text-[#7bdb3f] text-[13px] font-[400] max-w-[102px] whitespace-nowrap'>ورود به حساب کاربری</span>
            </div>
            <div className='flex flex-row gap-5 items-center'>
                <h5 className='dark:text-[#8CFF45] text-[#7bdb3f] text-[16px] font-[400]'> خوش برگشتی !</h5>
