        ...
        <div className='bg-[#303030] w-full rounded-3xl mt-2'>
            <div className='flex flex-row flex-wrap justify-between items-end gap-5 p-5 w-full'>
                ...
                <div className='flex flex-row max-[1179px]:w-full'>
                    <div className="border w-full lg:w-full justify-center border-[#ffffff] flex flex-row-reverse gap-2 items-center p-4 rounded-2xl">
                        <p className="text-white">تعداد آگهی : {totalCount.totalCount}</p>
