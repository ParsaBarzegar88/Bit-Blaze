...
const MortgageRentFilterFirst: FC<IProps> = ({ totalCount }) => {
    const provinces = [
        "همه",
        "تهران",
        "مازندران",
    ...
    const [guests, setGuests] = useState<string>(searchParams.get('search') || '');
    ...
    return (
        <div className='dark:bg-[#303030] bg-[#FFFFFF] dark:shadow-none shadow-[0_0px_16px_rgba(0,0,0,0.27)] w-full rounded-3xl mt-2'>
            <div className='flex flex-row flex-wrap justify-between items-end gap-5 p-5 w-full'>
                <div className='flex flex-col lg:w-fit w-full lg:flex-row flex-wrap gap-6 items-end'>
                    <div className="min-w-[200px] w-full lg:w-fit">
                        <Popover open={openProvince} onOpenChange={setOpenProvince}>
                            <PopoverTrigger asChild>
                                <div className='group'>
                                    <p className='dark:text-[#AAAAAA] text-[#5f5f5f] dark:group-hover:text-white group-hover:text-[#000000] font-[400] text-[13px]'>محل مورد نظر :</p>
                                    <Button
                                        variant="outline"
                                        role="combobox"
                                        aria-expanded={openProvince}
                                        className="w-full h-[50px] justify-between dark:bg-transparent bg-transparent rounded-2xl border-[#5f5f5f] dark:border-[#AAAAAA]
                                         group-hover:border-[#000000] dark:group-hover:border-[#FFFFFF] group-hover:text-[#FFFFFF]  dark:text-[#AAAAAA] text-[#5f5f5f] hover:bg-transparent"
                                    >
                                        <div className='flex flex-row gap-2 items-center dark:group-hover:text-white group-hover:text-black'>
                                            <IoLocationOutline className='dark:group-hover:text-[#FFFFFF] group-hover:text-black' />
                                            {selectedProvince || "انتخاب استان ..."}
                                        </div>
                                        <ChevronDown className="ml-0.5 h-4 w-4 shrink-0 opacity-50 border-[#AAAAAA] group-hover:text-black dark:group-hover:text-white" />
                                    </Button>
                                </div>
                            </PopoverTrigger>
                    ...
                    <div className="min-w-[150px] w-full lg:w-fit">
                        <Popover open={openSorts} onOpenChange={setOpenSorts}>
                            <PopoverTrigger asChild>
                                <div className='group'>
                                    <p className='dark:text-[#AAAAAA] text-[#5f5f5f] group-hover:text-[#000000] dark:group-hover:text-[#FFFFFF] font-[400] text-[13px]'>مرتب سازی بر اساس :</p>
                                    <Button
                                        variant="outline"
                                        role="combobox"
                                    ...
                                    >
                                        <div className='flex flex-row gap-2 items-center dark:group-hover:text-white group-hover:text-black'>
                                            <IoFilterOutline className='dark:group-hover:text-[#FFFFFF] group-hover:text-black' />
                                            {selectedSort || "محبوب ترین ها"}
                                        </div>
                                        <ChevronDown className="w-full justify-between dark:bg-transparent bg-transparent rounded-2xl border-[#AAAAAA] group-hover:text-black dark:group-hover:text-white hover:bg-transparent" />
                                    </Button>
                                </div>
                            </PopoverTrigger>
                    ...
                    <div className="min-w-[120px] w-full lg:w-fit">
                        <Popover open={openHouseType} onOpenChange={setOpenHouseType}>

                            <PopoverTrigger asChild>
                                <div className='group'>
                                    <p className='dark:text-[#AAAAAA] text-[#5f5f5f] group-hover:text-[#000000] dark:group-hover:text-[#FFFFFF] font-[400] text-[13px]'>نوع ملک :</p>
                                    <Button
                                        variant="outline"
                                        role="combobox"
                                        aria-expanded={openProvince}
                                    ...
                                    >
                                        <div className='flex flex-row gap-2 items-center dark:group-hover:text-white group-hover:text-black'>
                                            <BiSolidBuildings className='dark:group-hover:text-[#FFFFFF] group-hover:text-black' />
                                            {selectedHouseType || "نوع ملک"}
                                        </div>
                                        <ChevronDown className="ml-0.5 h-4 w-4 shrink-0 opacity-50 group-hover:text-black dark:group-hover:text-white" />
                                    </Button>
                                </div>
                            </PopoverTrigger>
                    ...
                    <div className="min-w-[120px] w-full lg:w-fit">
                        <Popover open={openTradeType} onOpenChange={setOpenTradeType}>
                            ...
                            <PopoverTrigger asChild>
                                <div className='group'>
                                    <p className='dark:text-[#AAAAAA] text-[#5f5f5f] group-hover:text-[#000000] dark:group-hover:text-[#FFFFFF] font-[400] text-[13px]'>نوع معامله :</p>
                                    <Button
                                        variant="outline"
                                        role="combobox"
                                        ...
                                        className="w-full h-[50px] justify-between dark:bg-transparent bg-transparent rounded-2xl border-[#5f5f5f] dark:border-[#AAAAAA]
                                         group-hover:border-[#000000] dark:group-hover:border-[#FFFFFF] group-hover:text-[#FFFFFF] dark:text-[#AAAAAA] text-[#5f5f5f] hover:bg-transparent"
                                    >
                                        <div className='flex flex-row gap-2 items-center w-full dark:group-hover:text-white group-hover:text-black'>
                                            <HiOutlineCurrencyDollar className='dark:group-hover:text-[#FFFFFF] group-hover:text-black' />
                                            {selectedTradeType || "نوع معامله"}
                                        </div>
                                        <ChevronDown className="ml-0.5 h-4 w-4 shrink-0 opacity-50 group-hover:text-black dark:group-hover:text-white" />
                                    </Button>
                                </div>
                    ...
                    <div className="min-w-[200px] w-full lg:w-fit">
                        <div className="group w-full">
                            <label className="block group-hover:text-black dark:group-hover:text-[#FFFFFF] text-[#5f5f5f] dark:text-[#AAAAAA] font-[400] text-[13px]">جستجو :</label>
                            <div className='flex flex-row relative'>
                                <input
                                    type="text"
                                    className="w-full h-[50px]  px-3 dark:bg-transparent bg-transparent border border-[#5f5f5f] dark:border-[#AAAAAA] rounded-2xl group-hover:border-black
                                     dark:group-hover:border-[#FFFFFF] text-[#5f5f5f] dark:text-[#AAAAAA] group-hover:text-black dark:group-hover:text-[#FFFFFF]
                                    dark:placeholder:text-[#AAAAAA] placeholder:text-[#5f5f5f] focus:outline-none dark:focus:border-white focus:border-black dark:focus:text-[#FFFFFF]
                                    focus:text-black text-right"
                                ...
                                />
                                <IoIosSearch className='dark:text-white text-black absolute left-3 top-3.5' size={23} />
                            </div>
                        </div>
                    </div>
                    <div onClick={handleOpenAiModal} className="flex h-fit max-[1179px]:w-full  sm:mt-0 whitespace-nowrap">
                        <div className="bg-[#10a37f] flex cursor-pointer text-center flex-row-reverse gap-2 items-center p-2 sm:p-4 rounded-xl sm:rounded-2xl w-full justify-center">
                ...
                <div className='flex flex-row max-[1179px]:w-full'>
                    <div className="border w-full dark:fill-white fill-black lg:w-full justify-center border-black dark:border-[#ffffff] flex flex-row-reverse gap-2 items-center p-4 rounded-2xl">
                        <p className="dark:text-white text-black">تعداد آگهی : {totalCount.totalCount}</p>
