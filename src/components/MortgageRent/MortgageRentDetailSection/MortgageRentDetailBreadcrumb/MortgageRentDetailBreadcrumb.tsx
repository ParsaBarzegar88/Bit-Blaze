...
const MortgageRentDetailBreadcrumb:FC<IProps> = ({houseTitle}) => {
  return (
    <Breadcrumb dir='rtl'>
      <BreadcrumbList>
        <BreadcrumbItem >
        ...
        <BreadcrumbItem >
          <BreadcrumbLink className='dark:hover:text-[#8CFF45] hover:text-[#4f9623] dark:text-[#AAAAAA] text-black' href="/mortgage-rent">رهن و اجاره</BreadcrumbLink>
        </BreadcrumbItem>
        <BreadcrumbSeparator className='rotate-180 text-[#AAAAAA]' />
        <BreadcrumbItem>
...
export default MortgageRentDetailBreadcrumb