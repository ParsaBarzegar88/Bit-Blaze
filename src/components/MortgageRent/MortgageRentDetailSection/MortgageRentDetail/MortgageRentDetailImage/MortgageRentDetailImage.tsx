            ...
            <div className='flex flex-col lg:flex-row justify-between w-full gap-6 lg:gap-8'>
                <div className='flex flex-col lg:flex-row gap-4 lg:gap-6 w-full'>
                    {houseData.photos !== null ? (
                        <div className='w-full lg:max-w-full sm:h-80 lg:h-full rounded-2xl lg:rounded-4xl overflow-hidden'>
                        ...
                        <div className='w-full lg:max-w-[675px] lg:w-2/3 h-64 sm:h-80 lg:h-[368px] flex justify-center items-center bg-gray-200 dark:bg-gray-700 rounded-2xl lg:rounded-4xl'>عکسی وجود ندارد</div>
                    )}
                    ...
                    <div className='flex flex-col lg:flex-col gap-4 w-full'>
                        {houseData.photos !== null ? (
                            ...
                            <div className='w-full  sm:h-full h-[200px] flex justify-center items-center bg-gray-200 dark:bg-gray-700 rounded-2xl lg:rounded-4xl'>عکسی وجود ندارد</div>
                        )}
