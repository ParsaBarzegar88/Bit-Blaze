...
const MortgageRentDetailImage:FC<IProps> = ({houseData}) => {
    return (
        <div className='flex flex-col lg:flex-row justify-between gap-6 lg:gap-8'>
            <div className='flex flex-col items-center lg:flex-row justify-between w-full gap-6 lg:gap-8 h-fit'>
                <div className='flex flex-col lg:flex-row gap-4 lg:gap-6 w-full'>
                    {houseData.photos !== null ? (
                        <div className='w-full h-[360px] lg:max-w-full rounded-2xl lg:rounded-4xl overflow-hidden'>
                    ...
                    <div className='flex flex-col lg:flex-col gap-4 w-full'>
                        {houseData.photos !== null ? (
                            <div className='w-full h-[172px] rounded-2xl lg:rounded-4xl overflow-hidden'>
                            ...
                            <div className='w-full  h-[172px] flex justify-center items-center bg-gray-200 dark:bg-gray-700 rounded-2xl lg:rounded-4xl'>عکسی وجود ندارد</div>
                        )}
                        <div className='w-full hidden md:flex  h-[172px] bg-[#AAAAAA] rounded-2xl lg:rounded-4xl'></div>
                    </div>
                </div>
