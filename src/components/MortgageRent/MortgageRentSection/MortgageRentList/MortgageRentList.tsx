...
const MortgageRentList: FC<IProps> = ({ houseData }) => {
    ...
    return (
        <div className='dark:bg-[#393939] bg-[#e2e2e2] group hover:scale-[1.01] hover:shadow-[0px_1px_10px_rgba(140,255,69,0.5)]
                 ...
                 transition-all duration-300 relative max-[850px]:w-full w-[49%] h-fit mt-10 rounded-tl-[16px] rounded-bl-[16px] rounded-br-[16px]
                    dark:before:bg-[#393939] before:bg-[#e2e2e2] before:[clip-path:polygon(25%_0,100%_0,100%_100%,0_100%)] 
                    before:h-6 before:rounded-tr-[17px] before:w-40 before:absolute before:-translate-y-5 before:top-0 before:right-0
                    after:absolute after:bg-transparent after:w-5 after:h-5 after:rounded-br-[60px] after:shadow-[6px_10px_0_0_rgba(226,226,266,1)]
                    after:transform-[rotate(23deg)] after:top-[-1.05rem] after:right-[9rem] dark:after:shadow-[6px_10px_0_0_rgba(57,57,57,1)]'>
            <div className="absolute top-[-1rem] right-[5px] w-[7.6rem] h-[2rem] rounded-[14px] 
                        outline-[5px] dark:outline-[#393939]
                        outline-[#e2e2e2]
                    ...
                    <div className='flex lg:flex-row flex-col gap-6'>
                        ...
                        <div className='flex flex-col gap-5 justify-between'>
                            ...
                            <span className='flex flex-row gap-1 items-center text-[#a7a7a7] dark:text-[#AAAAAA]'>
                                ...
                                <p className='text-black dark:text-[#FFFFFF] max-w-[160px] truncate'>{houseData.address}</p>
                            </span>
                            <div className='flex flex-row flex-wrap w-fit justify-between text-[#a7a7a7] dark:text-[#AAAAAA] items-center gap-2'>
                                ...
                                <div className='w-0.5 h-4 bg-[#a7a7a7] hidden sm:block'></div>
                                <div className='flex flex-row gap-1 items-center font-[300] text-[12px] sm:text-[13px]'>
                        ...
                        {houseData.discounted_price !== null ? (
                            <div className='flex flex-row gap-2 max-[1300px]:mt-5'>
                                <div className='flex flex-row gap-3'>
                                    ...
                                    <div className='dark:bg-[#FF5555] bg-red-500 text-[16px] font-[700] w-[50px] h-[28px] items-center rounded-[8px] flex justify-center text-[#FFFFFF]'>{discountPercentage}%</div>
                                </div>
                            </div>
                        ) : ""}
